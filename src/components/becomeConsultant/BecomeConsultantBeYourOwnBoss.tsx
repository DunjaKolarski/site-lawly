...
function BecomeConsultantBeYourOwnBoss() {
  ...
  return (
    <section className="be-your-own-boss">
      ...
      <div className="be-your-own-boss-scroll" ref={emblaRef}>
        <div className="be-your-own-boss-container">
          <div className="be-your-own-boss-item">
            ...
            <h4>Earn more</h4>
            <p>
              Most companies pocket 75% and leave you with only 25%. On Lawly
              you keep 75%. And you keep even more as you work with more
              clients.
            </p>
          </div>
          <div className="be-your-own-boss-item">
            ...
            <p>
              On Lawly, you can be your own boss. You aren't assigned clients
              and given deadlines. You decide which clients to work with, and
              set your own availability and meeting times.
            </p>
          </div>
          <div className="be-your-own-boss-item">
            <div className="be-your-own-boss-image">
            ...
            <p>
              ...
              scheduling a breeze so you can focus on helping students reach
